.class Lcom/android/phone/multiwaveview/Tweener;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/phone/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;

    .line 140
    new-instance v0, Lcom/android/phone/multiwaveview/Tweener$1;

    invoke-direct {v0}, Lcom/android/phone/multiwaveview/Tweener$1;-><init>()V

    sput-object v0, Lcom/android/phone/multiwaveview/Tweener;->mCleanupListener:Landroid/animation/Animator$AnimatorListener;
...
.method public constructor <init>(Landroid/animation/ObjectAnimator;)V
    ...
    .line 44
    iput-object p1, p0, Lcom/android/phone/multiwaveview/Tweener;->animator:Landroid/animation/ObjectAnimator;
...
.method static synthetic access$000(Landroid/animation/Animator;)V
    ...
    .prologue
    .line 36
    invoke-static {p0}, Lcom/android/phone/multiwaveview/Tweener;->remove(Landroid/animation/Animator;)V
...
.method private static remove(Landroid/animation/Animator;)V
    ...
    .prologue
    .line 48
    sget-object v2, Lcom/android/phone/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    .line 49
    .local v1, iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/Object;Lcom/android/phone/multiwaveview/Tweener;>;>;"
    :cond_a
    ...
    .line 51
    .local v0, entry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/Object;Lcom/android/phone/multiwaveview/Tweener;>;"
    invoke-interface {v0}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/android/phone/multiwaveview/Tweener;

    iget-object v2, v2, Lcom/android/phone/multiwaveview/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    .line 56
    .end local v0           #entry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/Object;Lcom/android/phone/multiwaveview/Tweener;>;"
    :cond_23
    return-void
.end method
...
.method private static varargs replace(Ljava/util/ArrayList;[Ljava/lang/Object;)V
    ...
    sget-object v5, Lcom/android/phone/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    .line 160
    .local v4, tween:Lcom/android/phone/multiwaveview/Tweener;
    if-eqz v4, :cond_29

    .line 161
    iget-object v5, v4, Lcom/android/phone/multiwaveview/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    .line 163
    iget-object v6, v4, Lcom/android/phone/multiwaveview/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    .end local v4           #tween:Lcom/android/phone/multiwaveview/Tweener;
    :cond_32
    return-void
.end method
...
.method public static reset()V
    ...
    .prologue
    .line 154
    sget-object v0, Lcom/android/phone/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;
...
.method public static varargs to(Ljava/lang/Object;J[Ljava/lang/Object;)Lcom/android/phone/multiwaveview/Tweener;
    .registers 22
    .parameter "object"
    .parameter "duration"
    .parameter "vars"
    ...
    .end local v13           #value:Ljava/lang/Object;
    :cond_123
    sget-object v14, Lcom/android/phone/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    check-cast v11, Lcom/android/phone/multiwaveview/Tweener;

    .line 101
    .local v11, tween:Lcom/android/phone/multiwaveview/Tweener;
    const/4 v2, 0x0
    ...
    .line 105
    new-instance v11, Lcom/android/phone/multiwaveview/Tweener;

    .end local v11           #tween:Lcom/android/phone/multiwaveview/Tweener;
    invoke-direct {v11, v2}, Lcom/android/phone/multiwaveview/Tweener;-><init>(Landroid/animation/ObjectAnimator;)V

    .line 106
    .restart local v11       #tween:Lcom/android/phone/multiwaveview/Tweener;
    sget-object v14, Lcom/android/phone/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    .line 127
    :cond_16b
    sget-object v14, Lcom/android/phone/multiwaveview/Tweener;->mCleanupListener:Landroid/animation/Animator$AnimatorListener;
    ...
    check-cast v14, Lcom/android/phone/multiwaveview/Tweener;

    iget-object v2, v14, Lcom/android/phone/multiwaveview/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v10, v14}, Lcom/android/phone/multiwaveview/Tweener;->replace(Ljava/util/ArrayList;[Ljava/lang/Object;)V
